...
{listeCrois.map((val,key)=>{
    return <div>
        ...
        <div >
         ...
         <td>
            <div className='croisdet'><b className='croisb'>{val.depart}</b> <br></br>
            {val.date} <br></br>
            <b className='croisp'>{val.prix} TND </b><br></br>
            <button className='croisbtn b'>
            <Link to={`/Details-croisiere/${val.depart}/${val.date}/${val.escale1}/${val.escale2}/${val.escale3}
