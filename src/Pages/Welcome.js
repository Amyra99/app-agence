...
Une proximité des clients : 34 points de vente sur tout le territoire tunisien
</div>
        </td>
...
Un call-center toujours à l'écoute de nos clients même en période de grand flux.</div>
        </td>
        <td>
<div className="g1">
<img src={dollar} height="60px" width="60px" class=""/><br></br>

Des tarifs les plus attractifs du marché (en TTC)</div>
        </td>    <td>
<div className="g1">
<img src={par} height="60px" width="60px" class=""/><br></br>

Une exhaustivité de l'offre Plus de 884.000 hôtels dans le monde</div>
        </td>
...
Plus de 18 ans d'expérience sur le marché</div>
        </td>
    </tr>
</table>
